...
**Plan version:** 1.1 (integrated from v0 + GPT Pro revisions; tightened for brownfield correctness; corrected command inventory + added dedupe/verification specifics)
